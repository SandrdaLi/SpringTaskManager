...
*/
	...
	public User findById(Long userId) {
		return jdbcTemplate.query(
				"SELECT NAME, USER_NAME, PASSWORD, DOB, PROFILE_IMAGE_ID, PROFILE_IMAGE_NAME FROM USER WHERE ID = ?",
	...
	public User findByUserName(String userName) {
		return jdbcTemplate.queryForObject(
				"SELECT ID, NAME, USER_NAME, PASSWORD, DOB, PROFILE_IMAGE_ID, PROFILE_IMAGE_NAME FROM USER WHERE USER_NAME = ?",
	...
	public void createUser(User user) {
		...
		/*jdbcTemplate.update(
				"INSERT INTO USER(NAME, USER_NAME, PASSWORD, DOB) VALUES(?,?,?,?)",
...
*/
		...
		jdbcTemplate.update(
			    new PreparedStatementCreator() {
			        public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
			            PreparedStatement ps = connection.prepareStatement("INSERT INTO USER(NAME, USER_NAME, PASSWORD, DOB) VALUES(?,?,?,?)", new String[]{"ID"});
	...
	public List<User> findAllUsers() {
		return this.jdbcTemplate.query(
				"SELECT ID, NAME, USER_NAME, PASSWORD, DOB, PROFILE_IMAGE_ID, PROFILE_IMAGE_NAME FROM USER ORDER BY ID DESC",
				new RowMapper<User>() {
...
//		jdbcTemplate.update(
//				"UPDATE USER SET NAME = ?, USER_NAME = ?, PASSWORD = ?, DOB = ?, PROFILE_IMAGE_ID = ?, PROFILE_IMAGE_NAME = ? WHERE ID = ?",
//				user.getName(), user.getUserName(), user.getPassword(), user.getDateOfBirth(), profileImageId,
//				profileImageName, userId);
		
		jdbcTemplate.update(
				"UPDATE USER SET NAME = ?, USER_NAME = ?, DOB = ?, PROFILE_IMAGE_ID = ?, PROFILE_IMAGE_NAME = ? WHERE ID = ?",
				user.getName(), user.getUserName(), user.getDateOfBirth(), profileImageId,
				profileImageName, userId);
	}
