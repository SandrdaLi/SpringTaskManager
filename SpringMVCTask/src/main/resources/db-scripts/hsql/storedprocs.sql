...
CREATE PROCEDURE GET_TASKS_BY_STATUS(IN v_status VARCHAR(20))
	...
	DECLARE RESULT CURSOR WITH RETURN FOR SELECT ID, NAME, STATUS, PRIORITY, CREATED_USER_ID, CREATED_DATE, ASSIGNEE_USER_ID FROM TASK WHERE STATUS = v_status FOR READ ONLY;
...
CREATE PROCEDURE GET_TASKS_BY_STATUS_ASSIGNEE_ID(IN v_status VARCHAR(20), IN v_assignee_id INTEGER)
	...
	DECLARE RESULT CURSOR WITH RETURN FOR SELECT ID, NAME, STATUS, PRIORITY, CREATED_USER_ID, CREATED_DATE, ASSIGNEE_USER_ID FROM TASK WHERE STATUS = v_status AND ASSIGNEE_USER_ID = v_assignee_id FOR READ ONLY;
...
CREATE PROCEDURE GET_TASKS_BY_STATUS_ASSIGNEE_USERNAME(IN v_status VARCHAR(20), IN v_assignee_name VARCHAR(20))
	...
	DECLARE RESULT CURSOR WITH RETURN FOR SELECT ID, NAME, STATUS, PRIORITY, CREATED_USER_ID, CREATED_DATE, ASSIGNEE_USER_ID FROM TASK WHERE STATUS = v_status AND ASSIGNEE_USER_ID = (SELECT ID FROM USER WHERE USER_NAME = v_assignee_name) FOR READ ONLY;
...
CREATE PROCEDURE GET_TASKS_BY_ASSIGNEE_ID(v_assignee_id INTEGER)
	...
	DECLARE RESULT CURSOR WITH RETURN FOR SELECT ID, NAME, STATUS, PRIORITY, CREATED_USER_ID, CREATED_DATE, ASSIGNEE_USER_ID FROM TASK WHERE ASSIGNEE_USER_ID = v_assignee_id FOR READ ONLY;
...
CREATE PROCEDURE GET_TASKS_BY_ASSIGNEE_NAME(v_assignee_name VARCHAR(20))
	...
	DECLARE RESULT CURSOR WITH RETURN FOR SELECT ID, NAME, STATUS, PRIORITY, CREATED_USER_ID, CREATED_DATE, ASSIGNEE_USER_ID FROM TASK WHERE ASSIGNEE_USER_ID = (SELECT ID FROM USER WHERE USER_NAME = v_assignee_name) FOR READ ONLY;
